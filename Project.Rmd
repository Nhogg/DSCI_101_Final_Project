...
first20 <- cleanedData %>%
  head(20)
write.csv(first20, "C:/Users/natha/OneDrive/Desktop/Spring 24/DSCI 101/DSCI_101_Final_Project/first20.csv")
paymentFraudPercent <- percentGenerator(first20, Payment_Method)
print("test")
